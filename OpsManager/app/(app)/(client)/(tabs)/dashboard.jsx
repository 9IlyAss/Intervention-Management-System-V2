...
export default function ClientDashboard() {
  ...
  try {
    ...
    // Format the data for display and ensure each has a unique ID
    const formattedInterventions = data.map((intervention, index) => ({
      id: intervention._id || intervention.id || `temp-id-${index}`, // Fallback to index-based ID if none exists
